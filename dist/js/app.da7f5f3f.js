(function (e) {
  function t(t) {
    for (
      var n, r, c = t[0], s = t[1], u = t[2], d = 0, l = [];
      d < c.length;
      d++
    )
      (r = c[d]),
  ...
  "56d7": function (e, t, a) {
    ...
    document.write(
      ...
      i.a.use(g.a, m["a"]),
      i.a.use(E),
      i.a.use(N["a"], { loading: Object(S["a"])("images/airplane.gif") }),
      i.a.use(V.a),
      new i.a({
        router: y["a"],
        store: k["a"],
  ...
  "95a2": function (e, t, a) {
    ...
    function p(e) {
      ...
      return new Promise(function (e) {
        e(
          Object(s["cloneDeep"])(
            d.get(l({ dbName: a, path: r, user: u, defaultValue: i })).value()
          )
        );
      });
    }
    function h() {
      ...
      return new Promise(function (e) {
        e(
          d.get(
            l({ dbName: a, path: r, user: i, validator: s, defaultValue: f })
          )
        );
      });
    }
  ...
  "9bd2": function (e, t, a) {
    ...
    c.interceptors.request.use(
      function (e) {
        return (
          (e.cancelToken = new r.a.CancelToken(function (e) {
      ...
      r = [
        function () {
          ...
          return a("footer", { staticClass: "footer" }, [
            ...
            //               attrs: { href: "https://github.com/alx-xlx/goindex" },
            //             },
            //             [e._v("goindex")]
            //           ),
    ...
    var n = a("be65"),
      ...
      o = {
        set: function () {
          ...
          Object.assign(n, a),
            r.a.set(
              "go2index-".concat("2.0.8-darkmode-0.1", "-").concat(e),
              t,
              n
            );
        },
